...
// Row is one section of onepage
$prefix = 'yolo_';
$is_one_page_section = get_post_meta(get_the_ID(),$prefix . 'is_one_page_section',true);
 ...
 */
$disable_element = $el_class = $full_height = $parallax_speed_bg = $parallax_speed_video = $full_width = $equal_height = $flex_row = $columns_placement = $content_placement = $parallax = $parallax_image = $css = $el_id = $video_bg = $video_bg_url = $video_bg_parallax = '';
...
if ( ! empty( $equal_height ) ) {
    $output .= '<div' . $str_el_id . ' class="yolo-full-width '. $section_class .'">'; // @TODO: need change fullwidth to page_layout
    ...
    $output .= '<div class = "yolo-full-width '. $section_class .'">';
    $output .=  '<div ' . implode( ' ', $wrapper_attributes ) . '>';
