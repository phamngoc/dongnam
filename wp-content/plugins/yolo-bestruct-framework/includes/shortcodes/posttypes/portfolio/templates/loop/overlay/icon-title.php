...
?>
<div class="entry-thumbnail icon-title <?php echo $overlay_effect; ?>">
        ...
        <div class="entry-hover-wrapper">
            <div class="entry-hover-inner">
                ...
                <?php else : ?>
                    ...
                    <a href="<?php echo get_permalink(get_the_ID()); ?>" class="overlay-title"><div class="title"><?php the_title(); ?></div></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
