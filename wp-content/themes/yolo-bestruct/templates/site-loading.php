...
$home_preloader_bg_color = $yolo_bestruct_options['home_preloader_bg_color'];
$home_preloader_spinner_color = $yolo_bestruct_options['home_preloader_spinner_color'];
...
?>
<div id="yolo-site-preload" <?php echo wp_kses_post($custom_bg_color);?> class="<?php echo esc_attr($home_preloader); ?>">
