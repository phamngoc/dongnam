...
class RWMB_Post_Field extends RWMB_Object_Choice_Field {
	...
	public static function normalize( $field ) {
		...
		if ( empty( $field['placeholder'] ) ) {
			$field['placeholder'] = esc_html__( 'Select a post', 'yolo-bestruct' );
			if ( is_string( $field['query_args']['post_type'] ) && post_type_exists( $field['query_args']['post_type'] ) ) {
				...
				$field['placeholder'] = sprintf( esc_html__( 'Select a %s', 'yolo-bestruct' ), $post_type_object->labels->singular_name );
			}
		}
