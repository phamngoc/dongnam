...
class Yolo_Mega_Menu {
	...
	public function yolo_mega_menu_enqueue_script() {
		...
		wp_register_style( 'yolo-megamenu-animate', get_template_directory_uri() . '/framework/core/megamenu/assets/css/animate.css', array(), null );
	...
	*/
	public function yolo_mega_menu_save_fields( $menu_id, $menu_item_db_id, $args ) {
		...
		if ( isset($_REQUEST['menu-item-megamenu_width'][$menu_item_db_id]) && is_array( $_REQUEST['menu-item-megamenu_width']) ) {
		...
		if ( isset($_REQUEST['menu-item-megamenu_columns'][$menu_item_db_id]) && is_array( $_REQUEST['menu-item-megamenu_columns']) ) {
		...
		if ( isset($_REQUEST['menu-item-megamenu_columns_tab'][$menu_item_db_id]) && is_array( $_REQUEST['menu-item-megamenu_columns_tab']) ) {
		...
		if ( isset($_REQUEST['menu-item-megamenu_sublabel'][$menu_item_db_id]) && is_array( $_REQUEST['menu-item-megamenu_sublabel']) ) {
		...
		if ( isset($_REQUEST['menu-item-megamenu_sublabel_color'][$menu_item_db_id]) && is_array( $_REQUEST['menu-item-megamenu_sublabel_color']) ) {
		...
		if ( isset($_REQUEST['menu-item-megamenu_background_image'][$menu_item_db_id]) && is_array( $_REQUEST['menu-item-megamenu_background_image']) ) {
		...
		if ( isset($_REQUEST['menu-item-megamenu_heading'][$menu_item_db_id]) && is_array( $_REQUEST['menu-item-megamenu_heading']) ) {
		...
		if ( isset($_REQUEST['menu-item-megamenu_icon'][$menu_item_db_id]) && is_array( $_REQUEST['menu-item-megamenu_icon']) ) {
		...
		if ( isset($_REQUEST['menu-item-megamenu_icon_color'][$menu_item_db_id]) && is_array( $_REQUEST['menu-item-megamenu_icon_color']) ) {
		...
		if ( isset($_REQUEST['menu-item-megamenu_icon_size'][$menu_item_db_id]) && is_array( $_REQUEST['menu-item-megamenu_icon_size']) ) {
		...
		if ( isset($_REQUEST['menu-item-megamenu_icon_alignment'][$menu_item_db_id]) && is_array( $_REQUEST['menu-item-megamenu_icon_alignment']) ) {
		...
		if ( isset($_REQUEST['menu-item-megamenu_widgetarea'][$menu_item_db_id]) && is_array( $_REQUEST['menu-item-megamenu_widgetarea']) ) {
	...
	*/
	function megamenu_generate_css_file($option_key) {
		...
		try {
			...
			?>
			<div class="error">
				<?php echo esc_html__('Caught exception:','yolo-bestruct') . esc_html($e->getMessage()) ?>
			</div>
			<?php
		}
	}
...
function please_set_menu(){
	$sentence = '<ul><li><a href="">'.	esc_html__( "No menu assigned","yolo-bestruct" ).'</a></li></ul>';
