...
*/
	...
	$layout_style = isset($yolo_bestruct_options['search_layout']) ? $yolo_bestruct_options['search_layout'] : 'container';
	$sidebar = isset($yolo_bestruct_options['search_sidebar']) ? $yolo_bestruct_options['search_sidebar'] : 'left' ;
	$archive_paging_style = isset($yolo_bestruct_options['search_paging_style']) ? $yolo_bestruct_options['search_paging_style'] : 'default';
	$archive_paging_align = isset($yolo_bestruct_options['search_paging_align']) ? $yolo_bestruct_options['search_paging_align'] : 'right';
	$sidebar_width = isset($yolo_bestruct_options['search_sidebar_width']) ? $yolo_bestruct_options['search_sidebar_width'] : 'small';
	$left_sidebar = isset($yolo_bestruct_options['search_left_sidebar']) ? $yolo_bestruct_options['search_left_sidebar'] : '';
	$right_sidebar = isset($yolo_bestruct_options['search_right_sidebar']) ? $yolo_bestruct_options['search_right_sidebar'] : '';
