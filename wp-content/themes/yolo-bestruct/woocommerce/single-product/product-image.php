...
global $post, $woocommerce, $product,$yolo_bestruct_options;
$single_product_show_image_thumb = isset($yolo_bestruct_options['single_product_show_image_thumb']) ? $yolo_bestruct_options['single_product_show_image_thumb'] : 0;
