...
*/
	...
	$layout_style = isset($yolo_bestruct_options['archive_layout']) ? $yolo_bestruct_options['archive_layout'] :'container';
    $sidebar = isset($yolo_bestruct_options['archive_sidebar']) ? $yolo_bestruct_options['archive_sidebar'] : 'right';
    $archive_paging_style = $yolo_bestruct_options['archive_paging_style'];
	$archive_paging_align = isset($yolo_bestruct_options['archive_paging_align']) ? $yolo_bestruct_options['archive_paging_align'] : 'center';
    $archive_display_type = isset($yolo_bestruct_options['archive_display_type']) ? $yolo_bestruct_options['archive_display_type']: 'medium-image';
    $sidebar_width = $yolo_bestruct_options['archive_sidebar_width'];
	$left_sidebar  = isset($yolo_bestruct_options['archive_left_sidebar']) ? $yolo_bestruct_options['archive_left_sidebar'] : 'sidebar-1';
	$right_sidebar = isset($yolo_bestruct_options['archive_right_sidebar']) ? $yolo_bestruct_options['archive_right_sidebar']: 'sidebar-1';
    $archive_display_columns = $yolo_bestruct_options['archive_display_columns'];
    // Process options
