...
class Yolo_MB_Conditional_Logic
{
	...
	public function enqueue( $hook )
	{
		...
		wp_register_script( 'conditional-logic', get_template_directory_uri(). '/framework/core/meta-box/js/conditional-logic.js', array(), '1.0.0', true );
		wp_localize_script( 'conditional-logic', 'conditions', $conditions );
		wp_enqueue_script( 'conditional-logic' );

		// wp_enqueue_script( 'conditional-logic', RWMB_JS_URL . 'conditional-logic.js', array(), RWMB_VER, true );
	}
