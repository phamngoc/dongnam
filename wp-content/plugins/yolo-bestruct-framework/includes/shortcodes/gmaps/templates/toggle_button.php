...
<script type="text/javascript">
    var map;
    var gmap_height   = '<?php echo $height;?>';
    var text_hide_map = '<?php echo esc_js( 'HIDE MAP', 'yolo-bestruct'); ?>';
    var text_show_map = '<?php echo esc_js( 'SHOW MAP', 'yolo-bestruct'); ?>';
...
<script async defer src="https://maps.googleapis.com/maps/api/js?v=3&key=<?php echo esc_html($api_key);?>&callback=initMap"
