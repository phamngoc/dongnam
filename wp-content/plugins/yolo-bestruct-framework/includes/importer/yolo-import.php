...
class Yolo_Import_Demo extends WP_Importer{
	...
	public function process_data() {
		 ...
		 * Check security
		 */
			check_ajax_referer( 'install-demo', 'security', esc_html__( 'Security Breach! Please contact admin!', 'yolo-bestruct' ) );
			// die('1111');
		/**
		 * Validate $_POST
		 */
			...
			$source_revslider = array(
				YOLO_IMPORTER . "/data-demo/{$name_demo}/revslider/home-shop-1.zip",
				YOLO_IMPORTER . "/data-demo/{$name_demo}/revslider/home-shop-2.zip",
				YOLO_IMPORTER . "/data-demo/{$name_demo}/revslider/home-shop-3.zip",
				YOLO_IMPORTER . "/data-demo/{$name_demo}/revslider/home-shop-4.zip",
				YOLO_IMPORTER . "/data-demo/{$name_demo}/revslider/home-business-1.zip",
				YOLO_IMPORTER . "/data-demo/{$name_demo}/revslider/home-business-2.zip",
				YOLO_IMPORTER . "/data-demo/{$name_demo}/revslider/home-business-3.zip",
				YOLO_IMPORTER . "/data-demo/{$name_demo}/revslider/home-services.zip",
			...
			switch ( $type_event ) {
				case 'start_import':
					 ...
					 */
						$response['msg']       = esc_html__( 'Start process importer data, please wait process posts...', 'yolo-bestruct' );
					 ...
					 */
					Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'Start Importer', 'yolo-bestruct' ) );
				...
				case 'check_files_systems':
					 ...
					 * Add this message to log file.
					 */
					Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Check File Systems', 'yolo-bestruct' ) );

					$message_file = array( esc_html__( 'Check File Systems', 'yolo-bestruct' ) );
					
					/**
					 * Check file content.xml
					 */
						if ( is_file( $file_demo ) ) {
							$message_file[] = esc_html__( 'Check file content.xml -> OK', 'yolo-bestruct' );
						} else {
							$message_file[] = esc_html__( 'Check file content.xml -> ERROR', 'yolo-bestruct' );
						}
					 ...
					 */
						if ( is_file( $widget ) ) {
							$message_file[] = esc_html__( 'Check file widgets.wie -> OK', 'yolo-bestruct' );
						} else {
							$message_file[] = esc_html__( 'Check file widgets.wie -> ERROR', 'yolo-bestruct' );
						}
					 ...
					 */
						if ( is_file( $option ) ) {
							$message_file[] = esc_html__( 'Check file option.json -> OK', 'yolo-bestruct' );
						} else {
							$message_file[] = esc_html__( 'Check file option.json -> ERROR', 'yolo-bestruct' );
						}
					...
					if(is_array($source_revslider) && !empty($source_revslider)){
						foreach($source_revslider as $revslider){
							if ( file_exists( $revslider ) ) {
								...
								$message_file[] = sprintf( esc_html__( 'Check Revslider file %s -> OK', 'yolo-bestruct' ), $base_name );
								// $message_file[] = esc_html__( 'Check file slider.zip -> OK', 'yolo-bestruct' );
							} else {
								$message_file[] = sprintf( esc_html__( 'Check Revslider file %s -> ERROR', 'yolo-bestruct' ), $base_name );
								// $message_file[] = esc_html__( 'Check file slider.zip -> ERROR', 'yolo-bestruct' );
							}
						}
					 ...
					 * Add this message to log file.
					 */
					Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'Check File Systems', 'yolo-bestruct' ) );
				...
				case 'get_content':
					 ...
					 * Add this message to log file.
					 */
					Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Process Posts', 'yolo-bestruct' ) );
					...
					if ( is_file( $file_demo ) ) {
						...
						$response['msg']       = esc_html__( 'Import all posts successfully, please wait process widgets...', 'yolo-bestruct' );

					} else {
						$response['msg']       = esc_html__( 'Skip process post, because a content.xml file does not exist on the system Please wait process widgets...', 'yolo-bestruct' );
					}
					$response['status']    = 'success';
					 ...
					 * Add this message to log file.
					 */
					Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'End Process Posts', 'yolo-bestruct' ) );
				...
				case 'get_option':
					 ...
					 * Add this message to log file.
					 */
					Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Process Options', 'yolo-bestruct' ) );

					if ( is_file( $option ) ) {
						$this->process_option( $option_url );
						$response['msg']       = esc_html__( 'Import all option successfully!', 'yolo-bestruct' );
					} else {
						$response['msg']       = esc_html__( 'Skip process options, because a option.json file does not exist on the system.', 'yolo-bestruct' );
					}
					 ...
					 * Add this message to log file.
					 */
					Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'End Process Options', 'yolo-bestruct' ) );
				...
				case 'get_widgets':
					 ...
					 * Add this message to log file.
					 */
					Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Process widgets', 'yolo-bestruct' ) );

					if ( is_file( $widget ) ) {
						$this->import_widgets( $widget_url );
						$response['msg']       = esc_html__( 'Import all widgets successfully, please wait process posts...', 'yolo-bestruct' );
					} else {
						$response['msg']       = esc_html__( 'Skip process widgets, because a widgets.wie file does not exist on the system Please wait process options...', 'yolo-bestruct' );
					}
					$response['status']    = 'success';
					 ...
					 * Add this message to log file.
					 */
					Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'End Process widgets', 'yolo-bestruct' ) );
				...
				case 'RevSlider':
					 ...
					 * Add this message to log file.
					 */
					Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Process Import RevSlider', 'yolo-bestruct' ) );

					if ( class_exists( 'RevSlider' )) {
						$this->import_RevSlider();
						$response['msg'] = esc_html__( 'Import revslider successfully!', 'yolo-bestruct' );
					} else {
						$response['msg'] = esc_html__( 'Skip process import revslider.', 'yolo-bestruct' );
					}
					 ...
					 * Add this message to log file.
					 */
					Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'End Process Import RevSlider', 'yolo-bestruct' ) );
				...
				case 'end_task':
					$response['msg']       = esc_html__( 'Import successfully! Thank you!', 'yolo-bestruct' );
					$response['status']    = 'success';
					 ...
					 * Add this message to log file.
					 */
					Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'Complete Importer', 'yolo-bestruct' ) );
				...
				default:
					 ...
					 * Message default
					 */
					$response['msg'] = esc_html__( 'Error! Cant process file content, please check again!', 'yolo-bestruct' );
	...
	function process_import( $file, $task = '', $index_post = 0 ) {
		...
		switch ( $task ) {
			case 'get_author':
				 ...
				 * Add this message to log file.
				 */
				Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Get Author', 'yolo-bestruct' ) );
				...
				$response['msg']       = esc_html__( 'Obtaining data author successfully, please wait process get category...', 'yolo-bestruct' );
				$response['next_task'] = 'get_content';
				$response['status']    = 'success';
				 ...
				 * Add this message to log file.
				 */
				Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'End Get Author', 'yolo-bestruct' ) );
			...
			case 'get_category':
				 ...
				 * Add this message to log file.
				 */
				Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Get Category', 'yolo-bestruct' ) );

				$this->process_categories();
				$response['msg']       = esc_html__( 'Obtaining data categories successfully, please wait process get tags...', 'yolo-bestruct' );
				$response['next_task'] = 'get_content';
				$response['status']    = 'success';
				 ...
				 * Add this message to log file.
				 */
				Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'End Get Category', 'yolo-bestruct' ) );
			...
			case 'get_tags':
				 ...
				 * Add this message to log file.
				 */
				Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Get Tags', 'yolo-bestruct' ) );

				$this->process_tags();
				$response['msg']       = esc_html__( 'Obtaining data tags successfully, please wait process get term...', 'yolo-bestruct' );
				$response['next_task'] = 'get_content';
				$response['status']    = 'success';
				 ...
				 * Add this message to log file.
				 */
				Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'End Get Tags', 'yolo-bestruct' ) );
			...
			case 'get_terms':
				 ...
				 * Add this message to log file.
				 */
				Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Get Term', 'yolo-bestruct' ) );
				...
				$response['msg']       = esc_html__( 'Obtaining data terms successfully, please wait process get posts...', 'yolo-bestruct' );
				$response['next_task'] = 'get_content';
				$response['status']    = 'success';
				 ...
				 * Add this message to log file.
				 */
				Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'End Get Term', 'yolo-bestruct' ) );
			...
			case 'get_posts':
				 ...
				 * Add this message to log file.
				 */
				Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Get Posts', 'yolo-bestruct' ) );

				$this->process_posts();
				$response['msg']       = esc_html__( 'Obtaining data posts successfully, please wait process get lists posts...', 'yolo-bestruct' );
				$response['next_task'] = 'get_content';
				$response['status']    = 'success';
				 ...
				 * Add this message to log file.
				 */
				Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'End Get Posts', 'yolo-bestruct' ) );
			...
			case 'get_list_posts':
				...
				if ( !empty( $index_post ) && $index_post == 0 ) {
					Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Get Lists Posts', 'yolo-bestruct' ) );
				}
				...
				if ( !empty( $response_list_post ) && $response_list_post === 'end_task' ) {
					...
					$response['msg']        = esc_html__( 'Obtaining lists posts successfully, please wait process attachment image...', 'yolo-bestruct' );
					$response['next_task']  = 'get_content';
					$response['status']     = 'success';
					...
					Yolo_Importer_Helpers::update_log(
						$response['msg'],
						esc_html__( 'End Get Lists Posts', 'yolo-bestruct' )
					);

				} else {

					$response['msg']        = sprintf( esc_html__( 'Please wait process post #%s...', 'yolo-bestruct' ), $index_post++ );
					$response['next_task']  = 'get_content';
					$response['status']     = 'success';
					$response['task']       = 'get_list_posts';
					...
					Yolo_Importer_Helpers::update_log(
						$response['msg'],
						sprintf(
							esc_html__( 'Process Lists Posts #%s', 'yolo-bestruct' ),
							$index_post
						)
					);
			...
			case 'get_attachment':
				if ( !empty( $index_post ) && $index_post == 0 ) {
					 ...
					 * Add this message to log file.
					 */
					Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Get Attachment', 'yolo-bestruct' ) );
				}
				...
				if ( !empty( $response_attachment ) && $response_attachment === 'end_task' ) {
					...
					$response['msg']        = esc_html__( 'Obtaining attachment image successfully, please wait process nav menu...', 'yolo-bestruct' );
					$response['next_task']  = 'get_content';
					$response['status']     = 'success';
					...
					Yolo_Importer_Helpers::update_log(
						$response['msg'],
						esc_html__( 'End Get Attachment', 'yolo-bestruct' )
					);

				} else {

					$response['msg']        = sprintf( esc_html__( 'Please wait process attachment image #%s...', 'yolo-bestruct' ), $index_post++ );
					$response['next_task']  = 'get_content';
					$response['status']     = 'success';
					$response['task']       = 'get_attachment';
					$response['index_post'] = $index_post;
					...
					Yolo_Importer_Helpers::update_log(
						$response['msg'],
						sprintf(
							esc_html__( 'Process attachment image #%s', 'yolo-bestruct' ),
							$index_post
						)
					);
			...
			case 'get_nav_menu':
				 ...
				 */
				if ( !empty( $index_post ) && $index_post == 0 ) {
					Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Get Nav Menu', 'yolo-bestruct' ) );
				}
				...
				if ( !empty( $response_list_post ) && $response_list_post === 'end_task' ) {
					...
					$response['msg']        = esc_html__( 'Obtaining data nav menu successfully, please wait process recheck all data post...', 'yolo-bestruct' );
					$response['next_task']  = 'get_content';
					$response['status']     = 'success';
					...
					Yolo_Importer_Helpers::update_log(
						$response['msg'],
						esc_html__( 'End Get Nav Menu', 'yolo-bestruct' )
					);

				} else {

					$response['msg']        = sprintf( esc_html__( 'Please wait process nav menu #%s...', 'yolo-bestruct' ), $index_post++ );
					$response['next_task']  = 'get_content';
					$response['status']     = 'success';
					$response['task']       = 'get_nav_menu';
					$response['index_post'] = $index_post;
					...
					Yolo_Importer_Helpers::update_log(
						$response['msg'],
						sprintf(
							esc_html__( 'Process Nav Menu #%s', 'yolo-bestruct' ),
							$index_post
						)
					);
			...
			case 'recheck':
				 ...
				 * Add this message to log file.
				 */
				Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Recheck Data Post', 'yolo-bestruct' ) );

				$this->backfill_parents();
				$this->backfill_attachment_urls();
				$this->remap_featured_images();

				$response['msg'] = esc_html__( 'Check all data post success, please wait process options...', 'yolo-bestruct' );

				/**
				 * Add this message to log file.
				 */
				Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'End Recheck Data Post', 'yolo-bestruct' ) );
	...
	function import_start( $file ) {
		...
		if ( is_wp_error( $import_data ) ) {
			...
			$response['status'] = 'error';
			$response['msg']    = esc_html__( 'Sorry, there has been an error.', 'yolo-bestruct' );
			$response['msg']    .= '<br />' . $import_data->get_error_message();

			/**
			 * Add this message to log file.
			 */
			Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'Error Import Data', 'yolo-bestruct' ) );
		 ...
		 * Add this message to log file.
		 */
		Yolo_Importer_Helpers::update_log( '', esc_html__( 'Start Import Data', 'yolo-bestruct' ) );

		wp_defer_term_counting( true );
		wp_defer_comment_counting( true );

		$response['msg']       = esc_html__( 'Begin the process of obtaining content data, please wait process get author...', 'yolo-bestruct' );
		$response['status']    = 'success';
		$response['next_task'] = 'get_content';
		 ...
		 * Add this message to log file.
		 */
		Yolo_Importer_Helpers::update_log( $response['msg'], esc_html__( 'Start Get Content', 'yolo-bestruct' ) );
		wp_send_json( $response );
	...
	function process_authors() {
		...
		if ( ! empty( $data_author ) ) {
			...
			Yolo_Importer_Helpers::update_log(
				'',
				esc_html__( 'Get List Author Success!', 'yolo-bestruct' )
			);
			...
			if ( is_array( $data_author ) ) {
				...
				foreach ( $data_author as $user_name => $info ) {
					...
					if ( is_wp_error( $user_id ) ) {
						...
						Yolo_Importer_Helpers::update_log(
							sprintf(
								esc_html__( 'Failed to create new user for %s. Their posts will be attributed to the current user.%s %s', 'yolo-bestruct' ),
								esc_html( $user_name ),
								'<br />',
								$user_id->get_error_message()
							),
							sprintf(
								esc_html__( 'ERROR: Create new user "%s"', 'yolo-bestruct' ),
								esc_html( $user_name )
							)
						);
						...
						Yolo_Importer_Helpers::update_log(
							'',
							sprintf(
								esc_html__( 'SUCCESS: Create new user "%s"', 'yolo-bestruct' ),
								esc_html( $user_name )
							)
						);
			...
			foreach ( $data_posts as $post ) {
				...
				if ( empty( $login ) ) {
					...
					Yolo_Importer_Helpers::update_log(
						$response['msg'],
						sprintf(
							esc_html__( 'Failed to import author %s.', 'yolo-bestruct' ),
		...
		foreach ( $data_categories as $cat ) {
			...
			if ( $term_id ) {
				...
				Yolo_Importer_Helpers::update_log(
					'', 
					sprintf(
						esc_html__( 'ERROR: Category exists "%s" have ID is: %s.', 'yolo-bestruct' ),
			...
			if ( ! is_wp_error( $category_id ) ) {
				...
				Yolo_Importer_Helpers::update_log(
					'', 
					sprintf(
						esc_html__( 'SUCCESS: Create category "%s" success have ID is: %s.', 'yolo-bestruct' ),
						esc_html( $cat['category_nicename'] ),
						absint( $category_id )
					)
				);
				...
				Yolo_Importer_Helpers::update_log(
					...
					sprintf(
						esc_html__( 'ERROR: Create category "%s".', 'yolo-bestruct' ),
						esc_html(
							$cat['category_nicename']
						)
					)
		...
		foreach ( $data_tags as $tag ) {
			...
			if ( $term_id ) {
				...
				Yolo_Importer_Helpers::update_log(
					'', 
					sprintf(
						esc_html__( 'ERROR: Tags exists "%s" have ID is: %s.', 'yolo-bestruct' ),
			...
			if ( ! is_wp_error( $tag_id ) ) {
				...
				Yolo_Importer_Helpers::update_log(
					'', 
					sprintf(
						esc_html__( 'SUCCESS: Create tags "%s" success have ID is: %s.', 'yolo-bestruct' ),
						esc_html( $tag['tag_name'] ),
						absint( $tag_id )
					)
				);
				...
				Yolo_Importer_Helpers::update_log(
					...
					sprintf(
						esc_html__( 'Failed to create post tag: %s.', 'yolo-bestruct' ),
						esc_html(
							$tag['tag_name']
						)
					)
		...
		foreach ( $data_terms as $term ) {
			...
			if ( $term_id ) {
				...
				Yolo_Importer_Helpers::update_log(
					'', 
					sprintf(
						esc_html__( 'ERROR: Term exists "%s" have ID is: %s.', 'yolo-bestruct' ),
			...
			if ( ! is_wp_error( $term_id ) ) {
				...
				Yolo_Importer_Helpers::update_log(
					'', 
					sprintf(
						esc_html__( 'SUCCESS: Create term "%s" success have ID is: %s.', 'yolo-bestruct' ),
						esc_html( $term['term_name']),
						absint( $term_id )
					)
				);
				...
				Yolo_Importer_Helpers::update_log(
					...
					sprintf(
						esc_html__( 'Failed to import: %s.', 'yolo-bestruct' ),
						esc_html(
							$term['term_taxonomy']
						)
					)
	...
	function process_list_post() {
		...
		foreach ( $list_post[0] as $post ) {
			...
			Yolo_Importer_Helpers::update_log(
				...
				esc_html__( 'Create Posts', 'yolo-bestruct' )
			);
	...
	function process_attachment() {
		if ( ! $this->fetch_attachments ) {
			...
			Yolo_Importer_Helpers::update_log(
				...
				esc_html__( 'Attachment Processing Error', 'yolo-bestruct' )
			);
		...
		foreach ( $list_attachment[0] as $post ) {
			...
			Yolo_Importer_Helpers::update_log(
				sprintf(
					...
					"\n" . sprintf( esc_html__( '+ Source: %s', 'yolo-bestruct' ), $url_image ),
					"\n" . sprintf( esc_html__( '+ URL: %s', 'yolo-bestruct' ), $upload['url'] )
				), 
				esc_html__( 'Upload Attachment Image', 'yolo-bestruct' )
			);
	...
	function fetch_remote_file( $url, $post ) {
		...
		if ( ! $headers ) {
			...
			Yolo_Importer_Helpers::update_log(
				...
				esc_html__( 'Import File Error', 'yolo-bestruct' )
			);
		...
		if ( $headers['response'] != '200' ) {
			...
			Yolo_Importer_Helpers::update_log(
				sprintf(
					esc_html__( 'Remote server returned error response %1$d %2$s', 'yolo-bestruct' ),
		...
		if ( 0 == $filesize ) {
			 ...
			 */
			Yolo_Importer_Helpers::update_log(
				esc_html__( 'Zero size file downloaded', 'yolo-bestruct' ), 
				esc_html__( 'Import File Error', 'yolo-bestruct' )
			);
		...
		if ( ! empty( $max_size ) && $filesize > $max_size ) {
			...
			Yolo_Importer_Helpers::update_log(
				sprintf(
					esc_html__( 'Remote file is too large, limit is %s', 'yolo-bestruct' ), 
	...
	function import_widgets( $file ) {
		...
		// if ( ! file_exists( $file ) ) {
		// 	wp_die(
		// 		esc_html__( 'Import file could not be found. Please try again.', 'yolo-bestruct' ),
		// 		'',
	...
	function import_data_widgets( $data ) {
		...
		if ( empty( $data ) || ! is_object( $data ) ) {
			 ...
			 */
			Yolo_Importer_Helpers::update_log(
				esc_html__( 'Import data could not be read. Please try a different file.', 'yolo-bestruct' ), 
				esc_html__( 'Import Data Widgets', 'yolo-bestruct' )
			);
			return false;
		}
		...
		foreach ( $data as $sidebar_id => $widgets ) {
			...
			if ( isset( $wp_registered_sidebars[$sidebar_id] ) ) {
				...
				$sidebar_message      = esc_html__( 'Sidebar does not exist in theme (using Inactive)', 'yolo-bestruct' );
			}
			...
			foreach ( $widgets as $widget_instance_id => $widget ) {
				...
				if ( ! $fail && ! isset( $available_widgets[$id_base] ) ) {
					...
					$widget_message      = esc_html__( 'Site does not support widget', 'yolo-bestruct' ); // explain why widget not imported
				}
				...
				if ( ! $fail && isset( $widget_instances[$id_base] ) ) {
					...
					foreach ( $single_widget_instances as $check_id => $check_widget ) {
						...
						if ( in_array( "$id_base-$check_id", $sidebar_widgets ) && (array) $widget == $check_widget ) {
							...
							$widget_message      = esc_html__( 'Widget already exists', 'yolo-bestruct' ); // explain why widget not imported
				...
				if ( ! $fail ) {
					...
					if ( $sidebar_available ) {
						...
						$widget_message = esc_html__( 'Imported', 'yolo-bestruct' );
					} else {
						$widget_message_type = 'warning';
						$widget_message = esc_html__( 'Imported to Inactive', 'yolo-bestruct' );
					}
				...
				$results[$sidebar_id]['widgets'][$widget_instance_id]['title'] = ! empty( $widget['title'] ) ? $widget['title'] : esc_html__( 'No Title', 'yolo-bestruct' ); // show "No Title" if widget instance is untitled
	...
	function process_option( $file ) {
		...
		foreach ( (array) $options_to_import as $option_name ) {
			...
			if( $primary_menu = wp_get_nav_menu_object( 'Main Menu' ) ) {
				...
				Yolo_Importer_Helpers::update_log(
					sprintf(
						esc_html__( 'ID Primary Menu is: %s.', 'yolo-bestruct' ),
						$primary_menu->term_id
					),
					esc_html__( 'Nav Menu Locations', 'yolo-bestruct' )
				);
			}
			...
			if( $mobile_menu = wp_get_nav_menu_object( 'Mobile Menu' ) ) {
				...
				Yolo_Importer_Helpers::update_log(
					sprintf(
						esc_html__( 'ID Mobile Menu is: %s.', 'yolo-bestruct' ),
						$mobile_menu->term_id
					),
					esc_html__( 'Nav Menu Locations', 'yolo-bestruct' )
				);
			...
			// 	Yolo_Importer_Helpers::update_log(
			// 		sprintf(
			// 			esc_html__( 'ID Top Bar Menu is: %s.', 'yolo-bestruct' ),
			...
			// 	Yolo_Importer_Helpers::update_log(
			// 		sprintf(
			// 			esc_html__( 'ID Off Canvas Menu is: %s.', 'yolo-bestruct' ),
			// 			$top_bar_menu->term_id
			// 		),
			// 		esc_html__( 'Menu Sidebar', 'yolo-bestruct' )
			// 	);
	...
	private function get_whitelist_options() {
		return apply_filters( 'options_import_whitelist', array(
			...
			'show_on_front',
			'widget_nav_menu',
			'theme_mods_yolo-bestruct',
			'yolo_custom_sidebars',
			'yolo_bestruct_options',
			'theme_mods_yolo-bestruct-child'
		) );
	}
