...
/*Function add multi select Type*/
...
if ( ! function_exists( 'yolo_shortcode_param_datetime' ) ) :
    ...
    vc_add_shortcode_param( 'yolo_datetime', 'yolo_shortcode_param_datetime', plugins_url() . '/yolo-bestruct-framework/admin/assets/plugins/datetimepicker/jquery.datetimepicker.js' );
endif;
...
if ( ! function_exists( 'yolo_icon_text_settings_field' ) ) :
    function yolo_icon_text_settings_field( $settings, $value ) {
        ...
        . '<input title="' . esc_html__('Click to browse icon', 'yolo-bestruct') . '" style="width:20%; height:34px;" class="browse-icon button-secondary" type="button" value="' . esc_html__('Browse Icon', 'yolo-bestruct') . '" >'
...
if ( ! function_exists( 'yolo_blog_cat_settings_field_shortcode_param' ) ) :
    function yolo_blog_cat_settings_field_shortcode_param( $settings, $value ) {
        ...
        $output .= '</select><input type="checkbox" id="' . $param_name . '_select_all" >' . esc_html__( 'Select All', 'yolo-bestruct' );
