...
class YOLO_Widget_MyAccount extends YOLO_Widget {
	public function __construct() {
		...
		$this->widget_description = esc_html__( "My Account Link Widget", 'yolo-bestruct' );
		$this->widget_id          = 'yolo-my-account';
		$this->widget_name        = esc_html__( 'YOLO My Account', 'yolo-bestruct' );
		$this->settings           = array(
			'login_text' => array(
				'type'  => 'text',
				'std'   => 'Login',
				'label' => esc_html__('Login Text','yolo-bestruct')
			),
			'logout_text' => array(
				'type'  => 'text',
				'std'   => 'Logout',
				'label' => esc_html__('Logout Text','yolo-bestruct')
			),
		);
		parent::__construct();
	}
