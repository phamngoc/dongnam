(function($){
    $(document).ready(function(){
        ...
        yolo_html_section +=            '<h3 class="poptit">Install Bestruct Theme Sections</h3>';
        ...
        yolo_html_section +=            '<i class="fa fa-spinner fa-spin"></i><p class="text-loading">Loading Data</p>';
        yolo_html_section +=        '</div>';
        ...
        jQuery.post( ajaxurl, {
            ...
            $('.yolo-selection').change(function(){
                ...
                if ( $('#sectionsStore .sc-layout').hasClass( $(this).val() ) ) {
                    ...
                    $(".sc-layout").removeClass("show_all");
                } else {
                    $(".sc-layout").addClass("show_all");
                }
            });
        });
    },
