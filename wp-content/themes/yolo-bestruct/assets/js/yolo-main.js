    ...
    YOLO.common = {
        ...
        tooltip : function () {
            if ($().tooltip && !isMobileAlt) {
                $('.site-content-archive-product .product-item-wrap.button-has-tooltip').each(function() {
    ...
    YOLO.woocommerce = {
        ...
        removeCart: function(){
            $(document).on('click','.mini-cart-remove', function(){
                setTimeout(function(){ YOLO.woocommerce.setCartScrollBar();}, 3000);                
            });
        },
        ...
        addToCart: function () {
            if($('.archive-product-wrap').length > 0){
                $('.archive-product-wrap').on('click', '.add_to_cart_button', function () {
                    var button = $(this),
        ...
        compare: function () {
            $('.post-type-archive-product a.add_to_compare').on('click', function (event) {
                event.preventDefault();
                var button = $(this),
                    buttonWrap = button.parent();
                    button.find('i').attr('class', 'fa fa-spinner fa-spin');
        ...
        quickView : function() {
            ...
            $('.post-type-archive-product .product-quick-view').on('click', function (event) {
                event.preventDefault();
        ...
        addToWishlist : function() {
            $('.post-type-archive-product').on('click', '.add_to_wishlist', function () {
                var button = $(this),
    ...
    YOLO.header = {
        ...
        stickyHeader : function() {
            if($('.header-sticky').length > 0){
                ...
                var sticky_effect = $('.header-sticky').attr('data-effect');
                if (YOLO.common.isDesktop()) {
