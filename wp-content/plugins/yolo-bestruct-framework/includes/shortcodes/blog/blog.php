...
if ( ! class_exists('Yolo_Framework_Shortcode_Blog') ) {
    class Yolo_Framework_Shortcode_Blog {
        ...
        function yolo_blog_shortcode($atts) {
            global $yolo_excerpt_length,$yolo_padding;
            ...
            $class[]           = $el_class;
            $class[]           = Yolo_BestructFramework_Shortcodes::yolo_get_css_animation($css_animation);
            ...
            ob_start();
            ?>
            <div class="<?php echo esc_attr($class_name) ?>" <?php if($styles_animation):?>style= "<?php echo esc_attr($styles_animation);?>"<?php endif;?>>
