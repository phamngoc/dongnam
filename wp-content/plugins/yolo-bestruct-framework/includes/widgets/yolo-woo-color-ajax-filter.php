...
class YOLO_WC_Widget_Color_Filter extends Yolo_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'Show color list to filter for shop page. This widget use for shop ajax page. ', 'yolo-bestruct' );
		$this->widget_id          = 'yolo_woocommerce_color_filter';
		$this->widget_name        = esc_html__( 'YOLO WooCommerce Color Ajax Filter', 'yolo-bestruct' );
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( empty( $new_instance['title'] ) ) {
			$new_instance['title'] = __( 'Color', 'yolo-bestruct' );
		}
	...
	public function form( $instance ) {
		...
		<p>
			<label>
				<?php esc_html_e( 'Title', 'yolo-bestruct' ); ?><br />
				<input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" value="<?php echo esc_attr( $instance['title'] ); ?>" />
			</label>
		</p>
        <p>
        	<label for="<?php echo esc_attr( $this->get_field_id( 'columns' ) ); ?>"><?php esc_html_e( 'Columns', 'yolo-bestruct' ); ?></label>
		...
		<p>
        	<label for="<?php echo $this->get_field_id( 'attribute' ); ?>"><?php esc_html_e( 'Attribute', 'yolo-bestruct' ); ?></label>
		...
		<div class="yolo-widget-attributes-table">
			<?php
				...
				if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) {
					...
					$output = sprintf( '<table><tr><th>%s</th><th>%s</th></tr>', esc_html__( 'Term', 'yolo-bestruct' ), esc_html__( 'Color', 'yolo-bestruct' ) );
