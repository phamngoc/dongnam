<?php
	...
	if ( ! function_exists( 'yolo_variation_styling' ) ):
		...
		function yolo_variation_styling() {
			...
			$fields[ 'color' ] = array(
				array(
					'label' => esc_html__( 'Color', 'yolo-bestruct' ), // <label>
					'desc'  => esc_html__( 'Choose a color', 'yolo-bestruct' ), // description
			...
			$fields[ 'image' ] = array(
				array(
					'label' => esc_html__( 'Image', 'yolo-bestruct' ), // <label>
					'desc'  => esc_html__( 'Choose a Image', 'yolo-bestruct' ), // description
			...
			$fields[ 'label' ] = array(
				array(
					'label' => esc_html__( 'Label', 'yolo-bestruct' ), // <label>
					'desc'  => esc_html__( 'The text of label (should be same as name)', 'yolo-bestruct' ), // description
