...
if ( ! class_exists('Yolo_Framework_Shortcode_Pricing') ) {
    class Yolo_Framework_Shortcode_Pricing {
        function __construct() {
            add_shortcode('yolo_pricing', array($this, 'yolo_pricing_shortcode' ));
        }
		function yolo_pricing_shortcode($atts) {
            $atts  = vc_map_get_attributes( 'yolo_pricing', $atts );
	...
	new Yolo_Framework_Shortcode_Pricing;
}
