...
<form class="variations_form cart" method="post" enctype='multipart/form-data' data-product_id="<?php echo absint( $product->get_id() ); ?>" data-product_variations="<?php echo htmlspecialchars( json_encode( $available_variations ) ) ?>">
	...
	<?php if ( empty( $available_variations ) && false !== $available_variations ) : ?>
		<p class="stock out-of-stock"><?php esc_html_e( 'This product is currently out of stock and unavailable.', 'yolo-bestruct' ); ?></p>
	<?php else : ?>
					...
					<?php if ( end( $attribute_keys ) === $attribute_name ): ?>
						<tr>
							...
							<td class="value"><a class="reset_variations"
							                     href="#"><?php echo esc_html__( 'Clear selection', 'yolo-bestruct' ) ?></a>
							</td>
						</tr>
					<?php endif; ?>
