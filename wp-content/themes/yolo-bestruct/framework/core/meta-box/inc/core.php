...
class RWMB_Core {
	...
	public function plugin_links( $links ) {
		$links[] = '<a href="'.esc_url('https://metabox.io/docs/').'">' . esc_html__( 'Documentation', 'yolo-bestruct' ) . '</a>';
		$links[] = '<a href="'.esc_url('https://metabox.io/plugins/').'">' . esc_html__( 'Extensions', 'yolo-bestruct' ) . '</a>';
		return $links;
	}
	...
	public function load_textdomain() {
		load_plugin_textdomain( 'yolo-bestruct', false, plugin_basename( RWMB_DIR ) . '/languages/' );
	}
