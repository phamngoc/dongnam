        ...
        function yolo_icon_box_shortcode($atts) {
            ...
            switch ($layout_type) {
                ...
                case 'style_8':
                    ...
                    break;
                case 'style_9':
                    $template_path = $plugin_path . '/templates/style_9.php';
                    break;
                case 'style_10':
                    $template_path = $plugin_path . '/templates/style_10.php';
                    break;
                 case 'style_10':
                    $template_path = $plugin_path . '/templates/style_11.php';
                    break;
                default:
                    $template_path = $plugin_path . '/templates/style_1.php';
            }
            ...
            <?php else : ?>
                <div class="icon-box-not-select"><?php echo esc_html__( 'Please select Icon Box!', 'yolo-bestruct' ); ?></div>
            <?php endif; ?>
        <?php
