...
?>
<div class="search-with-category header-customize-item" data-hint-message="<?php esc_html_e( 'Enter keyword to search', 'yolo-bestruct' ) ?>">
	<div class="search-with-category-inner search-box">
		<div class="form-search-left">
			<span data-id="-1"><?php esc_html_e( 'Categories', 'yolo-bestruct' ); ?></span>
