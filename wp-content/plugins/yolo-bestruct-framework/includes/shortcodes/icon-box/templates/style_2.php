...
<div class="<?php echo $layout_type; ?> icon-box-shortcode-wrap">
    <div class="icon-box-container">
        ...
        <div class="icon-content">
            <div class="background-content" <?php if($bg_color!=''): ?> style="background-color:<?php echo esc_attr($bg_color); ?>"<?php endif ?>></div>
            <div class="background-content-2" <?php if($bg_color!=''): ?> style="background-color:<?php echo esc_attr($bg_color); ?>"<?php endif ?>></div>
            <h2 class="icon-title">
